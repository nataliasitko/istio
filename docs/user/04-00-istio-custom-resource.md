...
| Field | Description | Validation |
| --- | --- | --- |
| **pilot** <br /> [IstioComponent](#istiocomponent) | Pilot defines component configuration for Istiod | None |
| **ingressGateway** <br /> [IstioComponent](#istiocomponent) | IngressGateway defines component configurations for Istio Ingress Gateway | None |
| **cni** <br /> [CniComponent](#cnicomponent) | Cni defines component configuration for Istio CNI DaemonSet | None |
| **proxy** <br /> [ProxyComponent](#proxycomponent) | Proxy defines component configuration for Istio proxy sidecar | None |
...
| **spec** <br /> [IstioSpec](#istiospec) | Spec defines the desired state of the Istio installation. | None |
| **status** <br /> [IstioStatus](#istiostatus) | Status represents the current state of the Istio installation. | None |
...
| Field | Description | Validation |
| --- | --- | --- |
| **limits** <br /> [ResourceClaims](#resourceclaims) |  | None |
| **requests** <br /> [ResourceClaims](#resourceclaims) |  | None |
